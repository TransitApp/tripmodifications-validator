...
export const CODE_TITLES = {
  ...
  E_MODIFICATIONS_CONTIGUOUS: 'Two modifications are contiguous and must be merged into one',
  ...
  E_TRIP_RUNS_ON_NO_SERVICE_DATE: 'Selected trip runs on none of the service_dates',
  ...
  E_SELECTED_TRIPS_NO_SHAPE: 'SelectedTrips sets no shape_id',
  E_SELECTOR_AMBIGUOUS_STOP: 'StopSelector uses stop_id alone on a trip that visits it twice',
  E_REPLACEMENT_STOP_NOT_ROUTABLE: 'ReplacementStop is not a routable stop (location_type is not 0)',
  E_TRAVEL_TIME_NEGATIVE: 'travel_time_to_stop is negative without the first stop as reference',
  ...
  E_ALERT_MISSING_TEXT: 'Alert has no header_text or no description_text',
  E_ALERT_NO_INFORMED_ENTITY: 'Alert has no informed_entity',
  E_ALERT_EMPTY_TIMERANGE: 'Alert active_period sets neither start nor end',
  E_ALERT_EMPTY_SELECTOR: 'Alert informed_entity has every field empty',
  ...
  W_TU_NO_UNMODIFIED_COUNTERPART: 'A modified trip has no plain TripUpdate for older clients',
  W_NO_TRIPUPDATE_FOR_MODIFICATION: 'No TripUpdate references this TripModifications entity',
  E_MODIFIED_TRIP_MISSING_FIELD: 'modified_trip is missing modifications_id or affected_trip_id',
  E_REPLACEMENT_TRIPUPDATE_EXISTS: 'A REPLACEMENT TripUpdate already exists for a selected trip',
