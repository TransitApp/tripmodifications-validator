...
export const CODE_TITLES = {
  ...
  E_MODIFICATION_NOOP: 'Modification neither replaces nor inserts anything',
  ...
  W_NO_PROPAGATED_DELAY: 'Modification changes the path but sets no propagated_modification_delay',
